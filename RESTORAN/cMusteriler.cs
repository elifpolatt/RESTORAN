...
namespace RESTORAN
{
    internal class cMusteriler
    {
        ...
        public bool musteriBilgileriGuncelle(cMusteriler m)
        {
            ...
            SqlConnection con = new SqlConnection(gnl.conString);
            SqlCommand cmd = new SqlCommand("Update musteriler set AD=@ad,SOYAD=@soyad,TELEFON=@telefon,ADRES=@adres,EMAIL=@email where ID=@musterid", con);
